...
class AvailableCollege {
  ...
  bool isWithin(DistanceCalculator distanceCalculator,double lat2, double lon2,double kms){

    if(location!.hasLocation() )
      return false;
    var distanceBetween = distanceCalculator.getDistanceBetween(location!.latitude!, location!.longitude!, lat2, lon2);
    print("distance to college" + distanceBetween.toString());
    return distanceBetween > 0 && distanceBetween < kms;
  }
